...
import { useDisclosure, useToast,Button,AlertDialog,AlertDialogOverlay,AlertDialogContent,AlertDialogHeader,AlertDialogCloseButton,AlertDialogBody,AlertDialogFooter } from "@chakra-ui/react"
...
const Login = () => {
  const { setUser,user, signIn, signUp,resendConfirmationCode } = useUserContext();
  ...
  const sendConfirmationCode = () => {
    ...
    .then((data)=>{
      console.log(data)
      produceToast(toast,"success","Success!","Succesfully re-sent confirmation code. Check your inbox!")
    })
    .catch((err)=>{
      console.log(err)
    ...
    <div class="flex-grow bg-white flex h-full">
      <div class="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <div class="mx-auto w-full max-w-sm lg:w-96">
          ...
          {unconfirmed && <><div class="mt-6 lg:bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
          <strong class="font-bold">Unconfirmed Email Address</strong><br />
          <span class="block sm:inline">Please confirm your email address before continuing. </span>
          <br />
          ...
          className = "ml-4">Resend Confirmation Email</button>
        </button>
        </div>
        </>}
          <div class="mt-8">
            <div class="mt-6">
              ...
              <div class="mt-4 flex items-center justify-between">
                ...
                <div class="mt-4 flex items-center justify-between">
                <button className = "font-medium text-indigo-600 hover:text-indigo-500 bg-transparent	" onClick={onOpen}>Reset Password</button>
